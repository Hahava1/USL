...
def get_meshrcnn_cfg_defaults(cfg):
    ...
    # [MODIFICADO] Renomeado de ZPRED_ON para LAYOUT_ON
    cfg.MODEL.LAYOUT_ON = False
    ...
    # ------------------------------------------------------------------------ #
    # Layout Head (Modificado de Z Predict Head)
    # ------------------------------------------------------------------------ #
    # [MODIFICADO] Renomeado de ROI_Z_HEAD para ROI_LAYOUT_HEAD
    cfg.MODEL.ROI_LAYOUT_HEAD = CN()
    cfg.MODEL.ROI_LAYOUT_HEAD.NAME = "FastRCNNFCHead"
    cfg.MODEL.ROI_LAYOUT_HEAD.NUM_FC = 2
    cfg.MODEL.ROI_LAYOUT_HEAD.FC_DIM = 1024
    cfg.MODEL.ROI_LAYOUT_HEAD.POOLER_RESOLUTION = 7
    cfg.MODEL.ROI_LAYOUT_HEAD.POOLER_SAMPLING_RATIO = 2
    # Type of pooling operation applied to the incoming feature map for each RoI
    cfg.MODEL.ROI_LAYOUT_HEAD.POOLER_TYPE = "ROIAlign"
    # Whether to use class agnostic for z regression
    cfg.MODEL.ROI_LAYOUT_HEAD.CLS_AGNOSTIC_Z_REG = False
    # Default weight on (dz) for normalizing z regression targets
    cfg.MODEL.ROI_LAYOUT_HEAD.Z_REG_WEIGHT = 5.0
    # The transition point from L1 to L2 loss. Set to 0.0 to make the loss simply L1.
    cfg.MODEL.ROI_LAYOUT_HEAD.SMOOTH_L1_BETA = 0.0
